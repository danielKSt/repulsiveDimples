# study2, fitted with conjugate direction line searches (Powell 1964).
#
# The paired script is study2_quad.R, which runs the same data, the same starting
# parameters and the same seeds through the other trust step method, so the two sets of
# fits differ only in how each step searches. Results go to Results/study2_conjugate.RDa,
...
load(file = "simulation_studies/Trust_region/Data/study2.RDa")
...
res <- run_study(study = "study2", variant = "conjugate", method = "conjugate",
