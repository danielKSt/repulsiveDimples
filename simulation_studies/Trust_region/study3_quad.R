# study3, fitted with quadratic interpolation (UOBYQA-style).
#
# The paired script is study3_conjugate.R, which runs the same data, the same starting
# parameters and the same seeds through the other trust step method, so the two sets of
# fits differ only in how each step searches. Results go to Results/study3_quad.RDa,
...
res <- run_study(study = "study3", variant = "quad", method = "quadratic",
