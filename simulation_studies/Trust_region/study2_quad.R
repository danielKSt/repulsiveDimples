# study2, fitted with quadratic interpolation (UOBYQA-style).
#
# The paired script is study2_conjugate.R, which runs the same data, the same starting
# parameters and the same seeds through the other trust step method, so the two sets of
# fits differ only in how each step searches. Results go to Results/study2_quad.RDa,
...
res <- run_study(study = "study2", variant = "quad", method = "quadratic",
