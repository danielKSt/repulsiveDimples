...
source(file = "simulation_studies/trust_region/")
...
save(par_thomas, rho_hat, K_hat, K_hat_unions, nTrue, nUnions, sidelength, file = "simulation_studies/Trust_region/study1.RDa")
